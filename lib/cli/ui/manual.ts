...
export class Manual {
  ...
  showManual(): void {
    ...
    const manual = [
      ...
      '',
      'DESCRIPTION',
      '       UNFOLD is a Homebrew-style CLI for managing programs, projects,',
      '       tasks, and subtasks. It provides a fast, intuitive interface for',
      ...
      '              Top-level organizational unit. Does not require a parent.',
      '              Contains: projects',
      '',
      ...
      '',
      'PHILOSOPHY',
      '       UNFOLD\'s CLI is inspired by Homebrew, emphasizing:',
      '         - Verb-first commands (list, create, remove)',
      '         - Consistent syntax patterns',
      '         - Intuitive shortcuts',
      '         - Forgiving input (fuzzy matching)',
      '         - Fast, minimal typing',
      '',
      'SEE ALSO',
